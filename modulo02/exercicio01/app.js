...
const my3FavoriteTVShows = ['Shameless', 'Dark', 'Vikings']
const sentence = `Minhas 3 séries favoritas são: ${my3FavoriteTVShows.join(', ')}.`.replace(', V', ' e V')
...
//console.log(`A string que a "typeSentence" armazena tem mais de ${numeroCaracteres} caracteres? ${String(typeSentence.length > numeroCaracteres).replace('t', 'T')}.`)
...
const noventaDois = 92
//console.log(`A soma entre o 1º e o 3º item de "ages" é menor ou igual a 92. Essa afirmação é: ${agesSum <= noventaDois}.`)
...
const isNotAString = typeof randomTVShow !== NaN
